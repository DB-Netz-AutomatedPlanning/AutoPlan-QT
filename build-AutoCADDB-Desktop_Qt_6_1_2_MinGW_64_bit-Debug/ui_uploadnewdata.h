...
public:
    ...
    QRadioButton *radioAddNew;
    QRadioButton *radioModify;
    ...
    void setupUi(QDialog *UploadNewData)
    {
        ...
        UploadNewData->resize(619, 366);
        gridLayout_3 = new QGridLayout(UploadNewData);
        gridLayout_3->setObjectName(QString::fromUtf8("gridLayout_3"));
        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        radioAddNew = new QRadioButton(UploadNewData);
        radioAddNew->setObjectName(QString::fromUtf8("radioAddNew"));

        verticalLayout->addWidget(radioAddNew);

        radioModify = new QRadioButton(UploadNewData);
        radioModify->setObjectName(QString::fromUtf8("radioModify"));

        verticalLayout->addWidget(radioModify);
        ...
        gridLayout_2->addWidget(lblEnableData, 4, 1, 1, 1);

        lblLocation = new QLabel(UploadNewData);
        lblLocation->setObjectName(QString::fromUtf8("lblLocation"));
        lblLocation->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_2->addWidget(lblLocation, 2, 0, 1, 1);
        ...
        gridLayout_2->addWidget(btnClickHere, 4, 2, 1, 1);
    ...
    void retranslateUi(QDialog *UploadNewData)
    {
        ...
        radioAddNew->setText(QCoreApplication::translate("UploadNewData", "Add New Data", nullptr));
        radioModify->setText(QCoreApplication::translate("UploadNewData", "Modify / Update Existing Data", nullptr));
        lblEnableData->setText(QCoreApplication::translate("UploadNewData", "To Enable Data Field, Click", nullptr));
        lblLocation->setText(QCoreApplication::translate("UploadNewData", "Enter New Location", nullptr));
        btnClickHere->setText(QCoreApplication::translate("UploadNewData", "here", nullptr));
        lblSelection->setText(QCoreApplication::translate("UploadNewData", "Select Existing Location", nullptr));
