#ifndef HOFROMUNPROCESSEDJSON_H
#define HOFROMUNPROCESSEDJSON_H

#include <QObject>
#include<QJsonDocument>

class HOFromUnprocessedJson : public QObject
{
    Q_OBJECT
public:
    explicit HOFromUnprocessedJson(QObject *parent = nullptr, QString filePath = "", const QString &newFilePath= "");
