#ifndef LAGEFROMUNPROCESSEDJSON_H
#define LAGEFROMUNPROCESSEDJSON_H

#include <QObject>
#include <QJsonDocument>

class LageFromUnprocessedJson : public QObject
{
    Q_OBJECT
public:
    explicit LageFromUnprocessedJson(QObject *parent = nullptr, QString filePath = "", const QString &newFilePath= "");
