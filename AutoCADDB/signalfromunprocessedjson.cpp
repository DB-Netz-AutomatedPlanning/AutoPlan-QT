...
QJsonObject SignalFromUnprocessedJson::properties(std::vector<QString> name, std::vector<QString> location, std::vector<QString> side, std::vector<QString> direction, int index)
{
    QJsonObject prop;
