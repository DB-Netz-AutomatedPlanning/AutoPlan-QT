...
#include <memory>
#include "../../AutoCADDB/coordinates.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Coordinates_t, stringdata0) + ofs), len 
...
const QMetaObject Coordinates::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Coordinates.offsetsAndSize,
    qt_meta_data_Coordinates,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Coordinates_t
