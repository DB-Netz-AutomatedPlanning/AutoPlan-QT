...
#include <memory>
#include "../../AutoCADDB/qjsonmodel.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QJsonModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QJsonModel_t qt_meta_stringdata_QJsonModel = {
    {
QT_MOC_LITERAL(0, 10) // "QJsonModel"
...
const QMetaObject QJsonModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_QJsonModel.offsetsAndSize,
    qt_meta_data_QJsonModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QJsonModel_t
, QtPrivate::TypeAndForceComplete<QJsonModel, std::true_type>
